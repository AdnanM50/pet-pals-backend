...
export const profileDetails = (req: Request, res: Response) => {
    // Example profile route, you can expand this to include authentication logic
    return res.status(200).json({ message: "Profile details" });
};